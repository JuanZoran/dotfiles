...
() {
  ...
  # 图标背景颜色
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=36
  # Custom icon.
  ...
  # 执行时间
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=16 # 背景
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=4  # 字体
  ...
  typeset -g POWERLEVEL9K_ASDF_BACKGROUND=30
  ...
  typeset -g POWERLEVEL9K_RANGER_BACKGROUND=30
  # Custom icon.
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=150
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=29
